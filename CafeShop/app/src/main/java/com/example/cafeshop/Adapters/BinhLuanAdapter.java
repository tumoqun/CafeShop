...
import com.example.cafeshop.View.BinhLuan;
...
public class BinhLuanAdapter extends ArrayAdapter<BinhLuan> {
    ...
    @NonNull
    private List<BinhLuan> objects;
    private StorageReference storageReference;

    public BinhLuanAdapter(@NonNull Activity activity, int resource, @NonNull List<BinhLuan> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final BinhLuan binhLuan=this.objects.get(position);
